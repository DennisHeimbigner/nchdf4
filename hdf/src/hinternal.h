...
*/
#ifndef hdf4_EXPORTS
error: hinternal => !hdf4_EXPORTS
#endif

/* If doing any of the master files, then redef HDFPUBLIC */

/* It should be the case that exactly one of these xxx_EXPORTS is defined */
#if defined cszip_EXPORTS || defined df24_EXPORTS || defined dfan_EXPORTS \
	|| defined dfcomp_EXPORTS || defined dfconv_EXPORTS || defined dfgr_EXPORTS \
	|| defined dfgroup_EXPORTS || defined dfimcomp_EXPORTS || defined dfjpeg_EXPORTS \
	|| defined dfknat_EXPORTS || defined dfkswap_EXPORTS || defined dfp_EXPORTS \
	|| defined dfr8_EXPORTS || defined dfrle_EXPORTS || defined dfsd_EXPORTS \
	|| defined dfstubs_EXPORTS || defined dfufp2i_EXPORTS || defined dfunjpeg_EXPORTS \
	|| defined dfutil_EXPORTS || defined HAVE_FMPOOL || defined hbitio_EXPORTS \
	|| defined hblocks_EXPORTS || defined hbuffer_EXPORTS || defined hchunks_EXPORTS \
	|| defined hcomp_EXPORTS || defined hcompri_EXPORTS || defined hdfalloc_EXPORTS \
	|| defined herr_EXPORTS || defined hextelt_EXPORTS || defined hfile_EXPORTS \
	|| defined hfiledd_EXPORTS || defined hkit_EXPORTS || defined mfan_EXPORTS \
	|| defined mfgr_EXPORTS || defined tbbt_EXPORTS || defined vattr_EXPORTS \
	|| defined vconv_EXPORTS || defined vg_EXPORTS || defined vgp_EXPORTS \
	|| defined vhi_EXPORTS || defined vio_EXPORTS || defined vparse_EXPORTS \
	|| defined vrw_EXPORTS || defined vsfld_EXPORTS
#ifdef _MSC_VER
#undef HDFPUBLIC
...
HDFPUBLIC TBBT_NODE  *tbbtins(TBBT_NODE ** root, VOIDP item, VOIDP key, intn (*compar)(VOIDP /* k1 */, VOIDP /* k2 */, intn /* arg */), intn arg);
...
HDFPUBLIC int32vinsertpair(VGROUP * vg, /* IN: vgroup struct */
...
HDFPUBLIC void *DFIgetspace
                (uint32 qty);

HDFPUBLIC int  DFIc2fstr
                (char *str, int len);

HDFPUBLIC char *DFIf2cstring
                (_fcd fdesc, intn len);
