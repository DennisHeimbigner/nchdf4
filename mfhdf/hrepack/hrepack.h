...
HDFLIBAPI int  hrepack         (const char* infname, const char* outfname, options_t *options);
HDFLIBAPI int  hrepack_addcomp (const char* str, options_t *options);
HDFLIBAPI int  hrepack_addchunk(const char* str, options_t *options);
HDFLIBAPI void hrepack_init    (options_t *options, int verbose);
HDFLIBAPI void hrepack_end     (options_t *options);
HDFLIBAPI int  hrepack_main    (const char* infile, const char* outfile, options_t *options);

HDFLIBAPI int  list(const char* infname,const char* outfname,options_t *options);
HDFLIBAPI int  read_info(const char *filename,options_t *options);
